                            ...
                            <div class="card border border-light-subtle rounded-4">
                                <div class="card-body p-3 p-md-4 p-xl-5">
                                    ...
                                    <div class="row gy-3 overflow-hidden">
                                        ...
                                        <div class="col-12">
                                            <div class="d-grid">
                                                <button class="btn bsb-btn-xl btn-primary" type="submit">Send Reset Link</button>
                                            </div>
                                         </div>
                                    </div>
                                </form>
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-end">
                                            <a href="#" class="link-secondary text-decoration-none" onClick={() => navigate('/login')}>Login</a>
                                            <a href="#" class="link-secondary text-decoration-none" onClick={() => navigate('/signup')}>Sign Up</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
